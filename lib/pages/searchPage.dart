...
const URL =
    'https://m.ctrip.com/restapi/h5api/globalsearch/search?source=mobileweb&action=autocomplete&contentType=json&keyword=';
...
class SearchPage extends StatefulWidget {
  ...
  const SearchPage(
      {Key key, this.hideLeft = true, this.searchUrl = URL, this.keyword, this.hint})
      : super(key: key);
